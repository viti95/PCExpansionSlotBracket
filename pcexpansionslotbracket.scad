...
module Part_SVideo() {
  right(6) cylinder(d=12, h=5);
}

module Part_RCA() {
  right(5) cylinder(d=10, h=5);
}

module Part_Jack35() {
  right(4) cylinder(d=8, h=5);
}
...
module Part_VGA() {
  right(1.5) {
    ...
    right(3.5) xrot(90) fwd(1) round3d(or=1) prismoid([16, 7], [20, 7], h=10, anchor=LEFT + FWD);
  }
}
...
module Part_DVI() {
  right(1.5) {
    ...
    right(3) xrot(90) fwd(1) round3d(or=1) prismoid([26, 7], [26, 7], h=10, anchor=LEFT + FWD);
  }
}
